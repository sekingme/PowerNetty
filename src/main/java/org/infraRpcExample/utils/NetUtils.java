...
public class NetUtils {
    ...
    private static boolean isSpecifyNetworkInterface(NetworkInterface networkInterface) {
        String preferredNetworkInterface = PropertyUtils.getString(Constants.DP_NETWORK_INTERFACE_PREFERRED,
                System.getProperty(Constants.DP_NETWORK_INTERFACE_PREFERRED));
    ...
    private static NetworkInterface findAddress(List<NetworkInterface> validNetworkInterfaces) {
        ...
        String networkPriority = PropertyUtils.getString(Constants.DP_NETWORK_PRIORITY_STRATEGY, NETWORK_PRIORITY_DEFAULT);
